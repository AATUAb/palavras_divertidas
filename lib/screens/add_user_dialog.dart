...
class _AddUserDialogState extends State<AddUserDialog> {
  ...
  final List<String> _letters = [
    "I", "U", "O", "A", "E", "P", "T", "L", "D", "M", "V", "C", "Q", "N", "R",
    "B", "G", "J", "F", "S", "Z", "H", "X", "CH", "LH", "NH",
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.person, color: AppColors.green, size: 20.w),
                      ...
                      Row(
                        ...
                        children: [
                          _buildLevelOption("Pré-Escolar", Icons.child_care, AppColors.green),
                          SizedBox(width: 10.w),
                          _buildLevelOption("1º Ciclo", Icons.school, AppColors.orange),
                        ],
                      ),
                      SizedBox(height: 10.h),
                      ...
                      if (_selectedLevel == "1º Ciclo")
                        Column(
                          children: [
                            ...
                            CheckboxListTile(
                              title: Text("Todas", style: TextStyle(fontSize: 12.sp)),
                              value: _selectAll,
                              onChanged: (bool? value) {
                                setState(() {
                                  _selectAll = value ?? false;
                                  _lettersSelected.updateAll((key, _) => _selectAll);
                                });
                              },
                            ),
                                ...
                                child: Column(
                                  children: _letters.map((letter) {
                                    return CheckboxListTile(
                                      title: Text(letter, style: TextStyle(fontSize: 12.sp)),
                    ...
                    children: [
                      ...
                      if (widget.onDelete != null)
                        TextButton.icon(
                          ...
                          label: Text("Eliminar", style: TextStyle(fontSize: 12.sp)),
                      ...
                      TextButton.icon(
                        ...
                        label: Text("Cancelar", style: TextStyle(fontSize: 12.sp)),
                        ...
                        onPressed: () {
                          if (_nameController.text.isNotEmpty) {
                            final selected = _lettersSelected.entries
                                ...
                                .map((e) => e.key)
                                .toList();
                            widget.onUserAdded(_nameController.text, _selectedLevel, selected);
                            Navigator.pop(context);
                          }
                        },
                        icon: Icon(Icons.save, size: 20.sp),
                        label: Text("Salvar", style: TextStyle(fontSize: 12.sp)),
