...
class _GameMenuState extends State<GameMenu> {
      ...
      drawer: custom.CustomDrawer(
        ...
        onAchievements: () {
          ...
          Future.delayed(const Duration(milliseconds: 100), () {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text("Conquistas em breve!", style: TextStyle(fontSize: 14.sp)),
                backgroundColor: AppColors.green,
        ...
        onDashboard: () {
          ...
          Future.delayed(const Duration(milliseconds: 100), () {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text("Dashboard em breve!", style: TextStyle(fontSize: 14.sp)),
                backgroundColor: AppColors.orange,
                duration: const Duration(seconds: 2),
                behavior: SnackBarBehavior.floating,
              ),
  ...
  void _navigateToGame(String gameName) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text("Jogo '$gameName' em desenvolvimento!", style: TextStyle(fontSize: 14.sp)),
        backgroundColor: AppColors.green,
        duration: const Duration(seconds: 2),
        behavior: SnackBarBehavior.floating,
      ),
