...
/// Para situações em que usa sempre usa sempre a fonte Slabo no 1º ciclo, e null no pré-escolar, como as intsruções
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Text(character.toUpperCase(), style: TextStyle(fontSize: 24.sp, fontFamily: 'Slabo', decoration: TextDecoration.none)),
        SizedBox(width: 8.w),
        Text(character.toUpperCase(), style: TextStyle(fontSize: 24.sp, fontFamily: 'Cursive', decoration: TextDecoration.none)),
        SizedBox(width: 16.w),
        Text(character.toLowerCase(), style: TextStyle(fontSize: 24.sp, fontFamily: 'Slabo', decoration: TextDecoration.none)),
        SizedBox(width: 8.w),
        Text(character.toLowerCase(), style: TextStyle(fontSize: 24.sp, fontFamily: 'Cursive', decoration: TextDecoration.none)),
      ],
    );
  }
}