...
Widget build(BuildContext context) {
  ...
  void startProgressTimer({
    ...
    _progressTimer?.cancel(); // Cancela anterior se existir
    _progressTimer = Timer.periodic(const Duration(milliseconds: 100), (t) {
      ...
      setState(() {
        // progressValue já é usado em GameDesign → funciona automaticamente
        // Quando chega a zero, cancela e chama o timeout
        if (frac >= 1.0) {
          progressValue = 0.0;
          t.cancel();
          onTimeout();
